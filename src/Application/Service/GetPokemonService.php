...
use App\Application\Dto\GetPokemonResponse;
use App\Domain\Limit;
use App\Domain\Offset;

class GetPokemonService
{
    public function run(GetPokemonRequest $getPokemonRequest): GetPokemonResponse
    {
        ...
        $limit    = new Limit($getPokemonRequest->limit);
        $offset   = new Offset($getPokemonRequest->offset);

        return new GetPokemonResponse($pokemons['results']);
    }
}
